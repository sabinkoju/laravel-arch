<div class="card card-default">
    ...
    <!-- /.input group -->
        ...
        <div class="form-group {{ ($errors->has('content'))?'has-error':'' }}">
            ...
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"  placeholder="Enter Contents" name="content"></textarea>
        ...
        <div class="form-group {{ ($errors->has('slug'))?'has-error':'' }}">
            <label>Page Slug
             ...
             <input type="text" class="form-control" placeholder="Enter Page Slug" name="slug">

                                ...
                                <div class="col-md-12" id="listing">
                                    ...
                                    <div class="card card-default">
                                        <div class="card-header with-border">
                                            ...
                                            $permission = helperPermissionLink(url('/mytasks/gallery'), url('/mytasks/gallery'));
                                                ...
                                                @forelse($gallery as $galleries)
                                                    <tr>
                                                        ...
                                                        <td class="text-right row" style="margin-right: 0px;">
                                                            ...
                                                            @if($allowDelete)
                                                                <form action="{{ route('gallery.destroy', $galleries->id)}}" method="post" style="display: inline-block">
                                                                    {{csrf_field()}}
                                                                    {{method_field('DELETE')}}
                                                                    <button type="submit"
                                ...
                                @if($allowAdd)
                                    <div class="col-md-3">
                                        @if(\Request::segment(4)=='edit')
                                            @include('backend.MyBackend.Gallery.edit')
                                        @else
                                            @include('backend.MyBackend.Gallery.add')
                                        @endif
                                    </div>
                                @endif
